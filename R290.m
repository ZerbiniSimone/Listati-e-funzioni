...
fun = @(X) fun_cont(M_r,p_1,p_2,p_3,p_4,p_5,p_6,X,T_4_sp,T_1_sp,eta_rig,eta_pp,A_leak,A_su,T_loss,V_s_exp,rv,fluido,scelta_rigeneratore);
...
[W_sh,W_pp,N,T_1,T_2,T_3,T_4,T_5,T_6,M_leak] = fun_orc(M_r,p_1,p_2,p_3,p_4,p_5,p_6,X,eta_rig,eta_pp,A_leak,A_su,T_loss,V_s_exp,rv,fluido,scelta_rigeneratore);
...
h_4 = py.CoolProp.CoolProp.PropsSI('H','P',p_4,'T',T_4 + 5,fluido); % entropia specifica al punto 4 [J/kgK]
