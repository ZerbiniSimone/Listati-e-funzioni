function[W_sh, W_pp, N, T_1, T_2, T_3, T_4, T_5, T_6, M_leak] = fun_orc(M_r, p_1, p_2, p_3, p_4, p_5, p_6, X, eta_rig, eta_pp, A_leak, A_su, T_loss, V_s_exp, rv, fluido, scelta_rigeneratore)
    ...
    while delta_T_5>=1 || delta_h_1>=10
       ...
       % calcolo prestazioni espansore
        ...
        % Potenza erogata (su,2-ex,2)
          ...
          p_ad = p_su_2*(1/rv)^gamma_su_2; % pressione sezione ad [Pa]
          s_ad = s_su_2; % entropia specifica nella sezione ad [J/kgK]
          h_ad = py.CoolProp.CoolProp.PropsSI('H','P',p_ad,'S',s_ad,fluido); % entalpia specifica sezione ad [J/kg]
          v_ad = v_su_2*rv; % volume specifico sezione ad [m]
